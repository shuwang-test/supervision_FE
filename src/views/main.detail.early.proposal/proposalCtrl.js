// ;(function() {
// 	'use strict'
// 	angular.module('app').controller('proposalCtrl', proposalCtrl)
...
// 		init()
// 		function init() {
// 			$rootScope.earlyCurrentMenu = 1
// 			getProposalList()
// 		}
// 		function getProposalList() {
// 			var projectId = localStorageService.get('projectId')
// 			ProposalList.getProposalList(projectId).then(function(res) {
// 				if (res) {
// 					console.log('res', res)
// 				}
// 			})
		...
		.controller('proposalCtrl', function(
			...
			function initProposalList() {
				getProposalList(
					...
					handleGetProposalListError
				)
			}
			function getProposalList(projectId, handle, handleError) {
			...
			function handleGetProposalList(res) {
				console.log('res', res)
			...
			function handleGetProposalListError(error) {
				console.log(error)
