// ;(function() {
// 	'use strict'
// 	angular.module('app').controller('constructPlanCtrl', constructPlanCtrl)
// 	function constructPlanCtrl(
// 		$scope,
// 		$rootScope,
// 		$timeout,
// 		$state,
...
;(function() {
	...
	angular
		.module('app')
		.controller('constructPlanCtrl', function(
			$scope,
			$rootScope,
			toastr,
			Constant,
			...
			function initConstructList() {
				getConstructList(
					global.projectId,
					handleGetConstructList,
					handleGetConstructListError
				)
			}
			function getConstructList(projectId, handle, handleError) {
				$httpFactory.setToken(global.token)
				$httpFactory
					.getConstructList(projectId)
					.then(handle)
					.catch(handleError)
			}

			function handleGetConstructList(res) {
				console.log('res', res)
			...
			function handleGetConstructListError(error) {
				console.log(error)
			...
			function deleteImageAndWord() {
				...
				deleteConstruct(data)
			}

			function deleteConstruct(data) {
				$httpFactory.setToken(global.token)
				$httpFactory
					.deleteConstruct(data)
					.then(function(res) {
