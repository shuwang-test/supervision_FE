// ;(function() {
// 	'use strict'
// 	angular.module('app').controller('designPlanCtrl', designPlanCtrl)
// 	function designPlanCtrl(
// 		$scope,
// 		$rootScope,
// 		$timeout,
// 		$state,
...
;(function() {
	...
	angular
		.module('app')
		.controller('designPlanCtrl', function(
			$scope,
			$rootScope,
			toastr,
			Constant,
			...
			function initDesignList() {
				getDesignList(
					global.projectId,
					handleGetDesignList,
					handleGetDesignListError
				)
			}
			function getDesignList(projectId, handle, handleError) {
				$httpFactory.setToken(global.token)
				$httpFactory
					.getDesignList(projectId)
					.then(handle)
					.catch(handleError)
			}

			function handleGetDesignList(res) {
				console.log('res', res)
			...
			function handleGetDesignListError(error) {
				console.log(error)
