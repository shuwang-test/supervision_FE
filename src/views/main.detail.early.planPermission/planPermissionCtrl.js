// ;(function() {
// 	'use strict'
// 	angular.module('app').controller('planPermissionCtrl', planPermissionCtrl)
// 	function planPermissionCtrl(
// 		$scope,
// 		$rootScope,
// 		$timeout,
// 		$state,
...
;(function() {
	...
	angular
		.module('app')
		.controller('planPermissionCtrl', function(
			$scope,
			$rootScope,
			toastr,
			Constant,
			...
			function initPlanList() {
				getPlanList(
					global.projectId,
					handleGetPlanList,
					handleGetPlanListError
				)
			}
			function getPlanList(projectId, handle, handleError) {
			...
			function handleGetPlanList(res) {
				console.log('res', res)
			...
			function handleGetPlanListError(error) {
				console.log(error)
