	...
	angular
		...
		.controller('fourthCtrl', function(
			...
			function initCurrentMenu() {
				$rootScope.detailThirdThirdMenu = 4
			}
			function initList() {
				$scope.imageList = []
				$scope.wordList = []
			...
			function initStatusList() {
				getStatusList(
					global.projectId,
					handleGetStatusList,
					handleGetStatusListError
				)
			}
			function getStatusList(projectId, handle, handleError) {
			...
			function handleGetStatusList(res) {
				console.log('res', res)
			...
			function handleGetStatusListError(error) {
				console.log(error)
